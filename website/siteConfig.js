...
const siteConfig = {
    ...
    tagline: 'PhD student using data science and computation for conflict and security applications',
    ...
    organizationName: 'natalie-ayers',
    ...
    copyright: `Copyright © ${new Date().getFullYear()} Natalie Ayers`,
